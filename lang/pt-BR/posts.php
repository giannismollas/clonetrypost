...
return [
    ...
    'form' => [
        ...
        'reddit' => [
            'settings' => 'Configurações do Reddit',
            'add_subreddit' => 'Adicionar subreddit',
            'remove_subreddit' => 'Remover',
            'subreddit' => 'Subreddit',
            'search_subreddit' => 'Buscar subreddits…',
            'title' => 'Título',
            'post_type' => 'Tipo de post',
            'type_self' => 'Texto',
            'type_link' => 'Link',
            ...
            'flair' => 'Flair',
            'no_flair' => 'Sem flair',
            'nsfw' => 'Marcar como NSFW',
            'spoiler' => 'Marcar como spoiler',
            'subreddit_required' => 'Adicione ao menos um subreddit para publicar.',
            'title_required' => 'Cada subreddit precisa de um título.',
            'url_required' => 'Um post de link precisa de uma URL.',
            'flair_required' => 'Este subreddit exige um flair.',
        ],
        'warnings' => [
    ...
    'content_types' => [
        ...
        'reddit_post' => [
            'label' => 'Post',
            'description' => 'Post de texto, link ou imagem em um subreddit',
        ],
    ],
