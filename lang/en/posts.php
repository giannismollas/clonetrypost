...
return [
    ...
    'form' => [
        ...
        'reddit' => [
            ...
            'subreddit' => 'Subreddit',
            'search_subreddit' => 'Search subreddits…',
            'title' => 'Title',
            'post_type' => 'Post type',
            'type_self' => 'Text',
            'type_link' => 'Link',
            ...
            'subreddit_required' => 'Add at least one subreddit to publish this post.',
            'title_required' => 'Each subreddit needs a title.',
            'url_required' => 'A link post needs a URL.',
            'flair_required' => 'This subreddit requires a flair.',
        ],
        'warnings' => [
    ...
    'content_types' => [
        ...
        'reddit_post' => [
            'label' => 'Post',
            'description' => 'Text, link, or image post to a subreddit',
        ],
    ],
